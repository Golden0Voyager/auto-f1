"""OpenF1 API MCP tools — real-time and recent F1 data."""
...
def register(mcp: FastMCP) -> None:
    """Register all OpenF1 tools on the given MCP server instance."""
    ...
    async def f1_race_summary_prompt(session_key: int) -> str:
        ...
        result = {
            ...
            "analysis_prompt": (
                "Based on the above F1 race data, provide a comprehensive "
                "race analysis in Chinese. Cover: "
